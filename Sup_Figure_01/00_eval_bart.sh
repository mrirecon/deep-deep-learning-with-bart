...
do
    if [[ $i -eq 30 ]]
    then
        wgh=$REPO/12_varnet/20201117_164101_default/11_weights
    else
        wgh=$REPO/12_varnet/20201117_164101_default/11_weights_$i
    fi
...
bart join 0 $MEAS $OUT_DIR/history_bart_train
...
bart join 0 $MEAS $OUT_DIR/history_bart_eval